...
class LandingPageState extends State<LandingPage> {
  ...
  Widget _myMenuBtn(String str, Function myFunc){
    return TextButton(
      ...
      child: Text(//play for main title, dancing script for remaining
        str,
                ...
                if (myDeviceWidth > 800) Card(
                  ...
                  child: Padding(
                    ...
                    Row(
                      ...
                      children: <Widget>[
                        _myMenuBtn("Home",(){ _animateToIndex(0);}),
                        const SizedBox(
                          width: 40,
                        ),
                        _myMenuBtn("Get Started",(){ _animateToIndex(1);}),
                        const SizedBox(
                          width: 40,
                        ),
                        _myMenuBtn("Templates",(){ _animateToIndex(2);}),
                        const SizedBox(
                          width: 40,
                        ),
                        _myMenuBtn("Features",(){ _animateToIndex(3);}),
                        const SizedBox(
                          width: 40,
                        ),
                        _myMenuBtn("Data Discussion",(){ _animateToIndex(4);}),
                      ],
                    ),
                  ),
                ) else Padding(
