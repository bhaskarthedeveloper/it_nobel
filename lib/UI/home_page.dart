...
class HomePageState extends State<HomePage>{
          ...
          child: Container(
            ...
            child: Column(
              children: <Widget> [
                ...
                Text(str,style: GoogleFonts.play(
          ...
          child: Container(
            ...
            child: Column(
              children: <Widget> [
                ...
                for ( String i in strArr ) ListTile(

                  title: Transform.translate(
                    offset: const Offset(-25, 0),
                    child: Text(i,style: GoogleFonts.lobsterTwo(
  ...
  List<Widget> myBannerList= <Widget>[
    ...
    _myBusinessAdvantage(brand,
        <String>[brandSub1,brandSub2],Colors.purple[300]),
    _myBusinessAdvantage(leads,
        <String>[leadsSub1,leadsSub2],Colors.orange[300]),
    _myBusinessAdvantage(betterService,
        <String>[betterServiceSub1,betterServiceSub2],
        Colors.blue[300]),
            ...
            children: <Widget>[
              Expanded(child: Center(
               ...
               SizedBox(
                 ...
                 child: Center(child:
                 decideMyLayoutWidget(<Widget>[
                    const AnimationObject
                      (50.00,250.00,Icons.face,"Login",10.00),
                    const AnimationObject
                      (50.00,180.00,Icons.face,"Login",10.00),
                    const AnimationObject
                      (50.00,140.00,Icons.face,"Login",10.00)
                  ])
