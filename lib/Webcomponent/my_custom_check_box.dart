...
class MyCustomCheckBox extends StatefulWidget{
  ...
  ///constructor
  const MyCustomCheckBox(this.myQuestion,
      this.checkBoxValuePair,this.mySelection);
...
class MyCustomCheckBoxState extends State<MyCustomCheckBox>{
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Row(
        children: <Widget>[
          Text(widget.myQuestion,style: const TextStyle(color: Colors.white),),
                ...
                child: Theme(
                  ...
                  child: CheckboxListTile(
                    ...
                    onChanged: (bool newValue) {
                      ...
                      setState(() {
                        widget.checkBoxValuePair[e] =
                        !widget.checkBoxValuePair[e];
                        //if only single value can be selected then
                        if(widget.checkBoxValuePair[e]){
                          widget.mySelection(e);
                          for(final String element in
                          widget.checkBoxValuePair.keys) {
                            if(e!=element){
