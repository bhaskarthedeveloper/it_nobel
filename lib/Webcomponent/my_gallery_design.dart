    ...
    return (!startCarasoulNow) ?
     Padding(
       ...
       child: Center(child: TextButton(
          ...
          child: const Text("Click me to see slide show of website template",
          ...
          child: Column(
            ...
            children: [
              if (_designType== "Artistic")
                Text(_designType,style: colorizeTextStyle,)
              else _myColorAnimText(galleryHeight,"Artistic"),
              if (_designType== "Blog")
                Text(_designType,style: colorizeTextStyle,)
              else _myColorAnimText(galleryHeight,"Blog"),
              if (_designType== "Event")
                Text(_designType,style: colorizeTextStyle,)
              else _myColorAnimText(galleryHeight,"Event"),
              if (_designType== "Portfolio")
                Text(_designType,style: colorizeTextStyle,)
              else _myColorAnimText(galleryHeight,"Portfolio"),
              if (_designType== "Business")
                Text(_designType,style: colorizeTextStyle,)
              else _myColorAnimText(galleryHeight,"Business"),
            ],
          ),
        ),
        Expanded(
          child: CarouselSlider.builder(
              ...
              itemBuilder: (BuildContext context,
                  ...
                  _myIndividualCarasoul(galleryHeight,_strArr6,itemIndex),
          ),
        )
      ],
    ):
          ...
          child: CarouselSlider.builder(
              ...
              itemBuilder: (BuildContext context,
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                    children: [
                      _myIndividualCarasoul(galleryHeight,_strArr1,itemIndex),
                      _myIndividualCarasoul(galleryHeight,_strArr2,itemIndex),
                      _myIndividualCarasoul(galleryHeight,_strArr3,itemIndex),
                      _myIndividualCarasoul(galleryHeight,_strArr4,itemIndex),
                      _myIndividualCarasoul(galleryHeight,_strArr5,itemIndex),
