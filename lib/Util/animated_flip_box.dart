...
class AnimationObject extends StatefulWidget {
  ...
  const AnimationObject(this.iconSize,this.sizeHeightMain,
      this.frontFace,this.textInput,this.textSize);
    ...
    return Stack(
      children: <Widget>[
        ...
        Transform(
          transform: Matrix4.identity()
            ..setEntry(3, 2, 0.001)
            ..translate(0.0, (sizeHeight / 2) * cos(angleValue),//sin(90+0)=cos0
                ((sizeHeight / 2) * sin(angleValue)))
